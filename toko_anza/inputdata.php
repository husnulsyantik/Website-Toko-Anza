...
<html>
  <head>
	...
	?>
	<body>
		<form name="input" id="input" method="post"  action="proses_inputdata.php">
              ...
              <div class="card">
                ...
                <div class="card-body">
                    ...
                    <select name="kd_kategoribarang" class="form-control">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="barcode"><strong><span class="help-block-none">Diisi secara manual jika masih tidak ada Scanner Barcode</strong></span>
                      </div>
                    </div><div class="line"></div>
					<div class="form-group row">
