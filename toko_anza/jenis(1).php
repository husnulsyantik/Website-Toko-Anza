...
<html>
  <head>
	...
	?>
    <body>
<form name="jenis" id="jenis" method="post"  action="proses_jenis.php">
	<br>
      <section class="forms">
			...
			<div class="col-lg-12">
              <div class="card">
                <div class="card-header d-flex align-items-center">
					<h1 class="h3 display"> <strong>JENIS BARANG</strong></h1>
                </div><br>
                <div class="card-body">
                    <div class="form-group row">
						<h2 class="col-sm-2 form-control-label">ID Jenis</h2>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="kd_jenisbarang" value="<?php echo $newID; ?>"disabled>
                      </div>
                    </div><div class="line"></div>
					<div class="form-group row">
                      <h2 class="col-sm-2 form-control-label">Nama Barang</h2>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" name="nm_jenisbarang"  >
                      </div>
                    </div><div class="line"></div>
                    <div class="form-group row">
